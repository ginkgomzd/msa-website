                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dataTable table table-striped display" width="100%" id="list">
                    ...
                    <tbody>
                        ...
                        foreach ($results as $priobill){
                            echo "<tr><td>{$priobill->id}</td><td><a href='{$user->generatePrioritizeBillLink($priobill->entity_type,$priobill->id)}'>{$priobill->title}</a></td><td>{$priobill->entity_type}</td><td>{$priobill->display_name}</td><td>{$priobill->timestamp}</td></tr>";
                        }
                    ?>
                    </tbody>
                </table>
