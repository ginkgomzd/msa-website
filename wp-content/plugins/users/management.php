...
?>
    ...
    <style>
        ...
        .users-table table td:nth-child(1),
        .users-table table th:nth-child(1),
        .users-table table th:nth-child(2),
    ...
    <form enctype="multipart/form-data" method="post" action="">
        <div class="wrap">
            <h1 class="wp-heading-inline mb-3">User management</h1>
            <div class="form-group form-horizontal">
                <div class="row">
                    <div class="col-md-9 mb-3">
                        <label for="client_id">Select Client:</label>
                        <select name="client_id" id="client_id" class="form-control" autocomplete="off">
                    ...
                    <div class="col-md-9">
                        ...
                        <select name="user_id" id="user_list" class="form-control" autocomplete="off">
