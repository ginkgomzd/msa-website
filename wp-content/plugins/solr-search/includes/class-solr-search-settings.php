    ...
    private function settings_fields () {
        ...
        $settings['standard'] = array(
            ...
            'fields'				=> array(
                ...
                array(
                    'id' 			=> 'solr_search_core_prefix',
                    'label'			=> __( 'Core Prefix' , 'solr-search-template' ),
                    'description'	=> __( 'Enter Solr server core prefix', 'solr-search-template' ),
                    'type'			=> 'text',
                    'default'		=> 'core_',
                    'placeholder'	=> __( '', 'solr-search-template' )
                ),
                array(
                    ...
                    'label'			=> __( 'Enable Solr Search' , 'solr-search-template' ),
