...
if (is_null($client) || is_null($id)){
    echo "<br/>Please call page with additional get parameters &client={int}&id={int} <br/>e.g ". get_site_url(). "/wp-admin/admin.php?page=hearings&client=1&id=1";
    wp_die();
}
...
$stmt = $db->prepare('SELECT m.m_id,m.pname,k.keyword
